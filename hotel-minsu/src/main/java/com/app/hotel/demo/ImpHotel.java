...
@Component("impHotel")
public class ImpHotel extends ParentDemo implements com.app.ea.demo.InfDemo{
	private final Logger log = LoggerFactory.getLogger(ImpHotel.class);
