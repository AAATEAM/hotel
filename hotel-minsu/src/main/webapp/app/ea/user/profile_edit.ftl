   		...
   		<td valign=top >
   		    <table class="table  table-bordered table-condensed    " >
				 <tr><td>中文姓名 </td><td onmouseover="rowOver(this)" onmouseout="rowOut(this)"><input  name="user.name" value="${rhs["user"].name?if_exists}"  onchange="javascript:action_user('update.do','column=name&id=${rhs["user"].id?if_exists}&columnValue='+escape(encodeURIComponent(this.value)))" /></td></tr>
   		   		 ...
   		   		 <tr><td>身份证</td><td onmouseover="rowOver(this)" onmouseout="rowOut(this)"><input   type="text"  value='${rhs["user"].identityCard?if_exists}'  onchange="javascript:action_user('update.do','column=identityCard&id=${rhs["user"].id?if_exists}&columnValue='+escape(encodeURIComponent(this.value)))" /></td></tr>
   		   		 <tr><td>手机号码</td><td onmouseover="rowOver(this)" onmouseout="rowOut(this)"><input   type="text"  value='${rhs["user"].phoneNumber?if_exists}'    onchange="javascript:action_user('update.do','column=phoneNumber&id=${rhs["user"].id?if_exists}&columnValue='+escape(encodeURIComponent(this.value)))" /></td></tr>
